...
<Layout >
            ...
            <Menu1 className="activeClassName " color="white" class="menu1" ><StyledLink to="/">Home</StyledLink></Menu1>
            ...
            <Menu1 className="activeClassName" color="white"class="menu2"><StyledLink to="/about">About</StyledLink></Menu1>
